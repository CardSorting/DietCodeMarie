...
`;class Mr extends St{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Checkbox")}}const Nr=Mr.compose({baseName:"checkbox",template:fo,styles:Hr,checkedIndicator:`
		<svg 
...
`;class Ur extends V{connectedCallback(){super.connectedCallback(),this.getAttribute("aria-label")||this.setAttribute("aria-label","Data Grid")}}const qr=Ur.compose({baseName:"data-grid",baseClass:V,template:ro,styles:_r});class Gr extends L{}const Wr=Gr.compose({baseName:"data-grid-row",baseClass:L,template:uo,styles:zr});class Qr extends ue{}const Xr=Qr.compose({baseName:"data-grid-cell",baseClass:ue,template:po,styles:jr}),Yr=(i,e)=>S`
	${H("block")} :host {
		border: none;
...
`;class wa extends pe{connectedCallback(){super.connectedCallback();const e=this.querySelector("label");if(e){const t="radio-group-"+Math.random().toString(16).slice(2);e.setAttribute("id",t),this.setAttribute("aria-labelledby",t)}}}const $a=wa.compose({baseName:"radio-group",template:Vo,styles:xa}),Ca=(i,e)=>S`
	${H("inline-flex")} :host {
		align-items: center;
		flex-direction: row;
		font-size: ${j};
...
`;class ka extends Ot{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Radio")}}const Ta=ka.compose({baseName:"radio",template:Ho,styles:Ca,checkedIndicator:`
...
`;class Ba extends Q{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const Pa=Ba.compose({baseName:"text-field",template:Zo,styles:Da,shadowOptions:{delegatesFocus:!0}}),{wrap:D}=nr(js,or());D(Er(),{name:"vscode-badge"});const Wa=D(Vr(),{name:"vscode-button"}),Qa=D(Nr(),{name:"vscode-checkbox",events:{onChange:"change"}});D(qr(),{name:"vscode-data-grid"});D(Xr(),{name:"vscode-data-grid-cell"});D(Wr(),{name:"vscode-data-grid-row"});D(Zr(),{name:"vscode-divider"});const Xa=D(ta(),{name:"vscode-dropdown",events:{onChange:"change"}}),Ya=D(na(),{name:"vscode-link"}),Ja=D(aa(),{name:"vscode-option"}),Za=D(ua(),{name:"vscode-panels",events:{onChange:"change"}}),Ka=D(fa(),{name:"vscode-panel-tab"}),el=D(ga(),{name:"vscode-panel-view"}),tl=D(ya(),{name:"vscode-progress-ring"}),il=D(Ta(),{name:"vscode-radio",events:{onChange:"change"}}),sl=D($a(),{name:"vscode-radio-group",events:{onChange:"change"}});D(Ra(),{name:"vscode-tag"});D(Ea(),{name:"vscode-text-area",events:{onChange:"change",onInput:"input"}});const nl=D(Pa(),{name:"vscode-text-field",events:{onChange:"change",onInput:"input"}});export{nl as V,Wa as a,Qa as b,Ya as c,sl as d,il as e,Za as f,Ka as g,el as h,Xa as i,Ja as j,tl as k};
